...
class AtualizadorEstoque {
    ...
    public function atualizarEstoque(array $dadosEstoque) {
        $verificaExistencia = "SELECT quantidade FROM estoque WHERE produto = :produto AND cor = :cor AND tamanho = :tamanho AND deposito = :deposito";
        $atualizaEstoque = "UPDATE estoque SET quantidade = quantidade + :quantidade WHERE produto = :produto AND cor = :cor AND tamanho = :tamanho AND deposito = :deposito";
